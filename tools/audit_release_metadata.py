...
EXPECTED_STAGE2 = "0cee62189f39da747b9a506b6b2f4cc369bbacdc"
...
require(manifest.get("provenance",{}).get("canonical_v04_stage2_merge")==EXPECTED_STAGE2,"Stage 2 provenance mismatch")
