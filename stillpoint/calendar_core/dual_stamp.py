...
def project_dual_stamp(
    ...
    *,
    ...
    # Common Calendar named dates belong to the retained 24-hour
    # coordination layer. They advance at midnight in permanent standard
    # time. Local sunset/dawn has separate jurisdiction over protected time.
