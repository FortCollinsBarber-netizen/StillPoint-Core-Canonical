...
from stillpoint.calendar_core.dual_stamp import (
    project_dual_stamp,
)
from stillpoint.calendar_core.models import (
    GeoPoint,
)
...
class DualStampTests(unittest.TestCase):
    ...
    def test_day_001_is_january_1(self):
        opening = date(
            2026,
            1,
            1,
    ...
    def test_next_year_day_001_follows_after_exactly_364_days(self):
        ...
        self.assertIsNone(
            old_year.calendar_address,
        )
        self.assertEqual(
            old_year.continuous_k,
            364,
        )
        ...
        self.assertEqual(
            new_year.calendar_address,
            "Y_2-001",
        )
        self.assertEqual(
            (
                new_year.common_date.month,
                new_year.common_date.day,
            ),
            (1, 1),
        )
        self.assertEqual(
            new_year.continuous_k,
            364,
        )
        self.assertEqual(
            new_year.common_date.weekday,
            "Thursday",
        )
